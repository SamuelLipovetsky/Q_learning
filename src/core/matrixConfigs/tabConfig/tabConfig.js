    ...
    return (
        ...
        <div className='tabs-wrapper'>
            <div className='tabs-menu'>
                <div className={`tab show-tab-${tabsToShow[0]}`} style={{ borderRight: "solid 1px", borderTop: "solid 1px", borderLeft: "solid 1px", borderTopLeftRadius: "2vh" }} onClick={() => handleClick([true, false, false],true)}>Gráficos</div>
                <div className={`tab show-tab-${tabsToShow[1]}`} style={{ borderRight: "solid 1px", borderTop: "solid 1px" }} onClick={() => handleClick([false, true, false],false)}>Celulas</div>
                <div className={`tab show-tab-${tabsToShow[2]}`} style={{ borderRight: 'solid 1px', borderTop: 'solid 1px', borderTopRightRadius: "2vh" }} onClick={() => handleClick([false, false, true],true)}>Variáveis</div>
            </div>
